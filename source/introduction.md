...
**RobotKit**是面向机器人开发者推出的机器人开发套件，内置多传感器驱动及传感器融合能力，提供建图，定位，感知，路径规划等算法，提供支持无刷电机和PID/MPC等运动规控算法；为开发者加速开发机器人，提供云端仿真，开发环境和文档，并提供四足机器人参考设计方案；指导开发者一步一步的搭建一个完整机器人；
